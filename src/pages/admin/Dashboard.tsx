            ...
            {activeTab === 'overview' && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <Card className="bg-pure-black/40 border-champagne-gold/30 hover:shadow-lg transition-all duration-300">
            ...
            {activeTab === 'projects' && (
              <>
                <div className="mb-8 flex justify-between items-center">
                  <div>
                    <h1 className="text-3xl font-bold text-champagne-gold">Manage Projects</h1>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody className="bg-pure-black/20 divide-y divide-champagne-gold/10">
                          {recentProjects.map((project) => (
                            <tr key={project.id} className="hover:bg-champagne-gold/5 transition-all duration-300">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div className="flex space-x-2">
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    className="border-champagne-gold/30 text-champagne-gold hover:bg-champagne-gold/10"
                                  >
                                  ...
                                  <Button
                                    size="sm"
                                    variant="outline"
                                    className="text-pure-white/70 border-pure-white/30 hover:bg-pure-white/10"
                                  >
