...
import { useProjects, PROJECT_TYPES } from '../../contexts/ProjectContext';
...
const AddProject: React.FC<AddProjectProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Project added successfully! Portfolio will update automatically.');
      onSuccess();
    } catch (error) {
