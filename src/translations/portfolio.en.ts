export const portfolioEn = {
  hero: {
    ...
    subtitle: "Discover our creative journey through stunning designs, innovative solutions, and impactful campaigns",
  ...
  modal: {
    purpose: "Purpose",
    purposeText: "Enhanced brand visibility and engagement",
    client: "Client",
    date: "Date",
